...
describe( 'S2 - 00 - When Starting a Session - Returning no name user < 30 min, non Expert', function() {  
    ...
    describe( 'Speech response is as expected', function() {
        ...
        it( 'output ssml contains intro', function() {
            ...
            expect( speechResponse.response.outputSpeech.ssml ).to.equal( "<speak> Welcome back.  What can I do for you? </speak>" )
        } )
    } )
    ...
    describe( 'Speech reprompt response is as expected', function() {
        ...
        it( 'reprompt ssml contains intro', function() {
            ...
            expect( speechResponse.response.reprompt.outputSpeech.ssml ).to.equal( "<speak>   You can ask for the weather, how many times you've visited, when you first visited, when you last visited, and you can change your name.  What would you like to do? </speak>" )
        } )
    } )
} )
