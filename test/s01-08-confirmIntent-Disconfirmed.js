...
describe( 'S1 - 08 - When testing confirmations - Confirmed', function() {  
    ...
    describe( 'Speech response is as expected', function() {
        ...
        it( 'output ssml contains new game empty player message', function() {
            ...
            expect( speechResponse.response.outputSpeech.ssml ).equals( "<speak> You did not confirm the last request.  What can I do for you? </speak>" )
        } )
    } )
} )
