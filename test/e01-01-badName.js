...
describe( 'E1 - 01 - When getting an unrecognized name', function() {  
        ...
        lambda.handler( {
           "session": {
              ...
              "attributes": {
                 ...
                 "lastSession": new Date().toUTCString(),
                 "name": " ",
                 "nextState" : " ",
              },
              "user": {
    ...
    describe( 'Speech response is as expected', function() {
        ...
        it( 'output ssml contains warn error', function() {
            ...
            expect( speechResponse.response.outputSpeech.ssml ).equals( "<speak> I'm sorry, I didn't get your name.  What should I call you? </speak>" )
        } )
    } )
    ...
    describe( 'Speech reprompt response is as expected', function() {
        ...
        it( 'reprompt ssml contains warn error', function() {
            ...
            expect( speechResponse.response.reprompt.outputSpeech.ssml ).equals( "<speak> What name should I call you? </speak>" )
        } )
    } )
} )
