...
describe( 'S1 - 00 - When Starting a Session - new User', function() {  
    ...
    describe( 'Attributes are completely defined', function() {
        it( 'sessionCount is 0', function() {
            expect( speechResponse.sessionAttributes.sessionCount ).not.to.be.undefined
            expect( speechResponse.sessionAttributes.sessionCount ).to.equal( 0 )
        } )
    ...
    describe( 'Speech response is as expected', function() {
        ...
        it( 'output ssml contains intro', function() {
            ...
            expect( speechResponse.response.outputSpeech.ssml ).equals( "<speak> Welcome to the Alexa Sampler.  You're new around here, what's your name? </speak>" )
        } )
    } )
