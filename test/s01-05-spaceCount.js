...
describe( 'S1 - 05 - When geting people on ISS', function() {  
    ...
    describe( 'Speech response is as expected', function() {
        ...
        it( 'output ssml contains new game empty player message', function() {
            ...
            expect( speechResponse.response.outputSpeech.ssml ).equals( "<speak> There are 3 people in space. Peggy Whitson, Fyodor Yurchikhin and Jack Fischer.  What can I do for you? </speak>" )
        } )
    } )
} )
