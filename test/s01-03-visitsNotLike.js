...
describe( 'S1 - 03 - When geting info total visits below like threshold', function() {  
    ...
    describe( 'Speech response is as expected', function() {
        ...
        it( 'output ssml contains new game empty player message', function() {
            ...
            expect( speechResponse.response.outputSpeech.ssml ).equals( "<speak> You have visited me <say-as interpret-as=\"number\">1</say-as> times.  What can I do for you? </speak>" )
        } )
    } )
} )
