...
describe( 'S1 - 07 - When geting the ISS location', function() {  
    ...
    describe( 'Speech response is as expected', function() {
        ...
        it( 'output ssml contains new game empty player message', function() {
            ...
            expect( speechResponse.response.outputSpeech.ssml.includes( "The I S S is currently over " ) ).to.be.true
        } )
    } )
} )
