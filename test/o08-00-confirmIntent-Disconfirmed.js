...
describe( 'O8 - 00 - When testing confirmations - Confirmed', function() {  
    ...
    describe( 'Speech response is as expected', function() {
        ...
        it( 'output ssml contains new game empty player message', function() {
            ...
            expect( speechResponse.response.outputSpeech.ssml ).equals( "<speak> You did not confirm the last request.   </speak>" )
        } )
    } )
} )
