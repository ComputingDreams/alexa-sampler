...
describe( 'S5 - 00 - When Starting a Session - Returning named user >= 30 min, Expert', function() {  
    ...
    describe( 'Speech response is as expected', function() {
        ...
        it( 'output ssml contains intro', function() {
            ...
            expect( speechResponse.response.outputSpeech.ssml.includes( "Julie, Welcome back to the Alexa Sampler.  I sure have missed you since your last visit.  What can I do for you?" ) ).to.be.true
        } )
    } )
    ...
    describe( 'Speech reprompt response is as expected', function() {
        ...
        it( 'reprompt ssml contains intro', function() {
            ...
            expect( speechResponse.response.reprompt.outputSpeech.ssml ).equals( '<speak> You can ask for the weather, visits, first visit, last visit or to change your name? </speak>' )
        } )
    } )
} )
