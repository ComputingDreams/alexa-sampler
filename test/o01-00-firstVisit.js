...
describe( 'O1 - 00 - When geting info on the first visit', function() {  
    ...
    describe( 'Attributes are completely defined', function() {
        it( 'sessionCount is 2', function() {
            expect( speechResponse.sessionAttributes.sessionCount ).not.to.be.undefined
            expect( speechResponse.sessionAttributes.sessionCount ).to.equal( 2 )
        } )
    ...
    describe( 'Speech response is as expected', function() {
        ...
        it( 'output ssml contains new game empty player message', function() {
            ...
            expect( speechResponse.response.outputSpeech.ssml ).equals( "<speak> You're first visit was on Wed, 17 May 2017 11:44:57 GMT.   </speak>" )
        } )
    } )
} )
