...
describe( 'O3 - 00 - When geting info total visits below like threshold', function() {  
    ...
    describe( 'Attributes are completely defined', function() {
        it( 'sessionCount is 15', function() {
            expect( speechResponse.sessionAttributes.sessionCount ).not.to.be.undefined
            expect( speechResponse.sessionAttributes.sessionCount ).to.equal( 15 )
        } )
    ...
    describe( 'Speech response is as expected', function() {
        ...
        it( 'output ssml contains new game empty player message', function() {
            ...
            expect( speechResponse.response.outputSpeech.ssml ).equals( "<speak> You have visited me <say-as interpret-as=\"number\">15</say-as> times.   </speak>" )
        } )
    } )
} )
