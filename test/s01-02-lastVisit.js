...
describe( 'S1 - 02 - When geting info on the last visit', function() {  
    ...
    describe( 'Speech response is as expected', function() {
        ...
        it( 'output ssml contains new game empty player message', function() {
            ...
            expect( speechResponse.response.outputSpeech.ssml ).equals( "<speak> You're last visit was on Mon, 12 Jun 2017 01:43:28 GMT.  What can I do for you? </speak>" )
        } )
    } )
} )
